    ...
    <>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <ScrollAnimation>
                <h2 className="text-display-sm mb-8">Contact Information</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`tel:${COMPANY_INFO.phone}`} className="text-neutral-600 hover:text-primary transition-colors">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">{COMPANY_INFO.address.full}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600 text-sm mb-1">{COMPANY_INFO.hours.weekdays}</p>
                    <p className="text-neutral-600 text-sm mb-1">{COMPANY_INFO.hours.saturday}</p>
                    <p className="text-neutral-600 text-sm">{COMPANY_INFO.hours.sunday}</p>
                  </div>
                </div>

                {/* WhatsApp */}
                <div className="bg-accent/10 p-6 rounded-2xl">
                  <h3 className="font-semibold text-lg mb-3">Quick Response via WhatsApp</h3>
                  <a
            ...
            <ScrollAnimation className="lg:col-span-3" delay={0.2}>
              <div className="bg-neutral-50 p-8 rounded-3xl">
                <h2 className="text-display-sm mb-2">Get a Free Quote</h2>
      ...
      <section className="section-padding bg-neutral-100">
        <div className="container-custom text-center">
          <h2 className="text-display-md mb-6">Service Area</h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {COMPANY_INFO.cities.map((city, index) => (
              <div
                key={index}
                className="bg-white px-6 py-3 rounded-full shadow-sm text-neutral-700 font-medium"
              >
                {city}
              </div>
            ))}
