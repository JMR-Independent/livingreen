          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <ScrollAnimation>
                ...
                {/* SMS/Text Message */}
                <div className="bg-gradient-to-br from-neutral-200 to-neutral-100 backdrop-blur-xl p-6 rounded-2xl border border-white/40 shadow-lg hover:shadow-xl transition-all duration-300">
                  <h3 className="font-semibold text-lg mb-3 text-neutral-900">Send a Text Message</h3>
                  <a
                    href={`sms:${COMPANY_INFO.phone}`}
                    className="btn-primary w-full justify-center flex items-center gap-2 shadow-md hover:shadow-lg bg-neutral-900 hover:bg-neutral-800"
                  >
